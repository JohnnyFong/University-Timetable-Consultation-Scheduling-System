...
Public Class Notification
    ...
    Private Sub Notification_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Equals(user, 1) Then 'lecture
            con = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0; Data Source=abc.accdb;")
            Dim sql As String = " SELECT Appointment.StudentID, Consultation.ConsultationDate, Consultation.Stime, Appointment.LectNoti, Student.StudentName, Appointment.CancelReason FROM ((Appointment INNER JOIN Consultation ON Appointment.ConsultationID = Consultation.ConsultationID) INNER JOIN Student ON Appointment.StudentID = Student.StudentID) WHERE (Appointment.LectNoti='Unread' OR Appointment.LectNoti='Read')"
            con.Open()
            ...
            While Not rcounter = Maxrows
                ...
                With seperator(rcounter)
                    ...
                    .Height = 10
                End With
                Dim s As String = d.Item(5).ToString
                Dim noti() = s.Split
                If (d.Item(3) = "Unread") Then
                    With feedtext(rcounter)
                        .Text = "Student " & d.Item(0) & " " & d.Item(4) & " has cancelled the appointment of " & d.Item(1) & " " & d.Item(2) & ":00." & vbNewLine & " Date :" & noti(0) & noti(1) & noti(2) & "."
                        .Multiline = True
                        .Dock = DockStyle.Fill
            ...
            While Not rcounter = Maxrows
                ...
                If (d.Item(2) = "Cancelled") Then
                    ...
                    If (d.Item(1) = "Unread") Then
                        With feedtext(rcounter)
                            .Text = "Your Appointment on " & d.Item(3) & " " & d.Item(4) & ":00 has been cancelled." & vbNewLine & " Reason :" & noti(0) & vbNewLine & "Date :" & noti(1) & " " & noti(2) & " " & noti(3) & "."
                            .Multiline = True
                            .Dock = DockStyle.Fill
                            .BorderStyle = BorderStyle.None
                            .Enabled = False
                ...
                Else
                    ...
                    If (d.Item(1) = "Unread") Then
                        With feedtext(rcounter)
                            .Text = "Your Appointment on " & noti(1) & " " & noti(2) & ":00 has been changed to " & noti(3) & " " & noti(4) & ":00 at " & noti(5) & " by lecturer " & noti(0) & "." & vbNewLine & "Date :" & noti(6) & " " & noti(7) & " " & noti(8) & "."
                            .Multiline = True
                            .Dock = DockStyle.Fill
                            .BorderStyle = BorderStyle.None
                            .Enabled = False
