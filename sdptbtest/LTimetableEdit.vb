Public Class LTimetableEdit
    ...
    Function setrecord(ByVal tbid As String, ByVal passdate As Date())
        Dim sql As String = "SELECT Format(Timetable.Tdate, 'dd/mm/yyyy hh:nn:ss am/pm'), Timetable.IntakeID, Timetable.ModuleID, Lecture.LectureName, Course.Sdate, Course.Duration_ps, Course.Duration_pc, Timetable.VenueID, Timetable.Tdate, Lecture.LectureID "
        ...
        Else
            ...
            txtlec.Text = dr.Item(9) + " " + dr.Item(3)
    ...
    Private Sub btnconf2_Click(sender As Object, e As EventArgs) Handles btnconf2.Click
        ...
        Dim duration As String() = txtduration.Text.Split(" ")
        Dim lectureid As String() = txtlec.Text.Split(" ")
        ...
        Dim leccmd As New OleDb.OleDbCommand(lecsql, LTimetableAdd.conn)
        leccmd.Parameters.AddWithValue("@duration", Integer.Parse(duration(0)))
        ...
        If lecdr.HasRows() Then
            ...
            While lecdr.Read()
                If lecdr.Item(0).Equals(timetableid) Then
                    flag = 1
                    Exit While
                End If
            End While
